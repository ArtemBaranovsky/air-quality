...
function App() {
  ...
  const sectors = [
    {
      name: "Промышленность",
      imgUrl: require("./assets/sectors-list/pexels-pixabay-326410 1.png"),
    ...
    {
      name: "Транспорт",
      imgUrl: require("./assets/sectors-list/pexels-cottonbro-4604564 1.png"),
    ...
    },
    {
      ...
      imgUrl: require("./assets/sectors-list/pexels-aleksejs-bergmanis-681335 1.png"),
    ...
    {
      name: "Энергия",
      imgUrl: require("./assets/sectors-list/pexels-cottonbro-3992206 1.png"),
      description: "Обеспечение доступа к недорогостоящим источникам энергии в быту для приготовления пищи, отопления и освещения"
    },
    {
      name: "Энергетика",
      imgUrl: require("./assets/sectors-list/pexels-flickr-157039 1.png"),
    ...
    },
    {
      ...
      imgUrl: require("./assets/sectors-list/pexels-vladislav-vasnetsov-2682683 1.png"),
